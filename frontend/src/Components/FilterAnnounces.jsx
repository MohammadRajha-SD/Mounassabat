        ...
        <div>
            ...
            <div className="container px-3 mx-auto py-10">
                ...
                {annonces.length > 0 ? (
                        ...
                        {annonces.map((annonce, index) => (
                            <div key={index} className="card relative bg-white shadow-lg rounded-lg overflow-hidden">
                                ...
                                <div className="p-5">
                                    ...
                                    <p className="text-gray-500 font-serif font-medium">{annonce.sub_category}</p>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <p className="text-gray-500 font-serif inline-flex font-bold">{annonce.price}<span className='text-gray-500 mx-2 font-serif font-bold'>MAD</span></p>
                    ...
                    <p className="text-center w-full text-gray-700 dark:text-gray-200 text-3xl">No posts available</p>
                )}
                {/* Announces END */}
            </div>
        </div>
