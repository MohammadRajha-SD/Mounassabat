    ...
    return (
        <>
            <div className='min-h-screen  bg-gray-100 '>
                ...
                <div className="flex flex-col md:flex-row py-20 gap-5 mx-10">
                    ...
                    <div className="w-full md:w-96 h-auto bg-white shadow-md rounded-xl px-3 p-4 flex flex-col justify-between">
                        {/* ICON && Text Header */}
