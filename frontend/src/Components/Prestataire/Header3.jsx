    ...
    return (
        <div className="fixed bg-white w-full flex flex-col md:flex-row justify-between items-center px-2 md:px-10 py-2 z-10 shadow-none md:shadow-md">
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
                ...
                {/* Progress Circle 3 */}
                <div className="bg-[#e6cf8c] rounded-full flex justify-center items-center" style={{ width: '30px', height: '30px' }}>
            ...
            <div className="flex items-center space-x-2">
                <Link className="bg-[#e6cf8c] text-white p-2 rounded-lg" to='/AnnounceForm2'>
